    ...
    public static boolean checkDiag1() {
        for (int row = 0; row <= 2; row++) {
            for (int col = 0; col <= 3; col++) {
                if (Constants1.board.boardArray[row][col].equals(Constants1.player2())
                && Constants1.board.boardArray[row+1][col+1].equals(Constants1.player2())
                && Constants1.board.boardArray[row+2][col+2].equals(Constants1.player2())
                && Constants1.board.boardArray[row+3][col+3].equals(Constants1.player2())) {
                    return true;
                }
            }
        }
